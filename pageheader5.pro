...
UBUNTU_TRANSLATION_DOMAIN="pageheader5.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheader5/tests/autopilot/run
aptest.depends  = sub-pageheader5

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheader5/tests/unit
unittest.depends  = sub-pageheader5
